...
￼￼￼￼￼￼￼￼￼￼￼
![](https://i.ibb.co/tb0tHWM/trasport-layer-in-network-model.png)
...
![](https://i.ibb.co/NN5kpyf/tcp-segment.png)
...
#### TCP Windows
Acknowledgement 필드의 값을 읽기 전에 필요한 sequence 
number의 범위
...
![](https://i.ibb.co/ZdHHYMR/firewall.png)
...
![](https://i.ibb.co/DkkFCbp/application-layer-and-osi-model.png)
...
![](https://i.ibb.co/LvY8JLv/all-the-layers-working-in-union.png)
