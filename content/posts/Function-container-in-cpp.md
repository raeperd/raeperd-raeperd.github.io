---
title: "Function Container in Cpp"
date: 2020-03-10T23:24:58+09:00
...
결과적으로는 이런 방법을 사용해서 일반적인 후킹을 구현하는 방법을 찾지는 못했는데 구현된 코드의 모양이 재미있기도 하고, 혹시 나중에 쓸 일이 있을까 싶어 이렇게 기록해 둔다.   
 cuckcoo sandbox의 경우 후킹의 대상이 되는 함수들의 목록을 저장해두는 파일이 있다. 인자의 수, 타입, 반환형들의 나열이 있는데 해당 파일을 읽어 후킹 하는 코드를 작성하는 식으로 구현되어 있는 듯 하다. 
